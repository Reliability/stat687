...
Welcome to `r rmarkdown::metadata$title`. <!--This course is part of the statistical engineering series on reliability and life-data analysis.-->  The course presents advanced statistical concepts for extracting decision-quality information from real-world reliability (a.k.a. survivability, time-to-event) data.
